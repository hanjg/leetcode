...
### 逆向思维 ###
- [最小操作次数使元素相等](../src/array/MinimumMovesToEqualArrayElements.java)
  - n-1个元素+1 == 1个元素-1，等价于每次对一个元素-1，直到所有元素相等

### 矩阵转置
- [旋转图像](../src/array/RotateImage.java)
  - 顺时针旋转90度==先y轴反转，再y=x直线反转（转置）